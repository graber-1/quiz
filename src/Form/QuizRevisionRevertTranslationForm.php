...
use Drupal\quiz\Entity\QuizInterface;
 ...
 * @ingroup quiz
 */
class QuizRevisionRevertTranslationForm extends QuizRevisionRevertForm {
  ...
  /**
   * Constructs a new QuizRevisionRevertTranslationForm.
   *
  ...
  protected function prepareRevertedRevision(QuizInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\quiz\Entity\QuizInterface $default_revision */
    $latest_revision = $this->QuizStorage->load($revision->id());
