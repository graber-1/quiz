...
class QuizController extends ControllerBase implements ContainerInjectionInterface {
   ...
   *
   * @param \Drupal\quiz\Entity\QuizInterface $quiz
   *   A Quiz  object.
   *
   * @return array
  ...
  public function revisionOverview(QuizInterface $quiz) {
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\quiz\QuizInterface $revision */
        ...
        if ($latest_revision) {
          ...
          if ($revert_permission) {
            $links['revert'] = [
              ...
              Url::fromRoute('entity.quiz.translation_revert', ['quiz' => $quiz->id(), 'quiz_revision' => $vid, 'langcode' => $langcode]) :
